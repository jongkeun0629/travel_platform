                ...
                <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            <div className="relative" ref={reviewRef}>
                                ...
                                >
                                    후기
                                    <FaAngleDown
                                        className={`h-4 w-4 ml-1 transition-transform duration-200 ${reviewOpen ? 'rotate-180' : ''
                                            }`}
                                    />
                                </button>
                                {reviewOpen && (
                            ...
                            <div className="relative" ref={tripRef}>
                                ...
                                >
                                    여행
                                    <FaAngleDown
                                        className={`h-4 w-4 ml-1 transition-transform duration-200 ${tripOpen ? 'rotate-180' : ''
                                            }`}
                                    />
                                </button>
                                {tripOpen && (
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <span className="text-sm text-gray-700">
                            안녕하세요, <span className="font-semibold text-blue-600">{user.userId}</span>님
                        </span>
                        <Link
                            to="/profile"
                            onClick={closeAllMenus}
